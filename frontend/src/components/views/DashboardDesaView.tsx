    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="bg-white p-6 rounded-2xl border border-[#E6E1D5] shadow-xs space-y-4">
        <div className="flex items-center justify-between flex-wrap gap-2">
          <h3 className="font-title font-bold text-base text-[#2C4219]">Data Lahan: Progress Pertumbuhan per Blok</h3>
            ...
            <div key={plot.id} className="p-4 rounded-xl bg-[#FAF6EE] border border-[#E6E1D5] space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[11px] text-[#433A30]/70">PIC Lahan: {plot.leaderName} • {plot.areaSize}</p>
                </div>
                <span className={`
      ...
      <div className="bg-white p-6 rounded-2xl border border-[#E6E1D5] shadow-xs space-y-4">
        <h3 className="font-title font-bold text-base text-[#2C4219]">Data Panen: Riwayat Log Hasil Panen Terakhir</h3>
          ...
          <table className="w-full text-left border-collapse text-xs">
            <thead>
              <tr className="bg-[#FAF6EE] text-[#2C4219] font-title font-bold border-b border-[#E6E1D5]">
                ...
                <th className="p-3 rounded-r-xl">PIC Panen</th>
              </tr>
            </thead>
      ...
      {!isAdmin && (
        <div className="bg-white p-6 rounded-2xl border border-[#E6E1D5] shadow-xs space-y-4">
          <h3 className="font-title font-bold text-base text-[#2C4219]">Data User Community: Daftar Anggota Terdaftar</h3>
      ...
      <div className="bg-white p-6 rounded-2xl border border-[#E6E1D5] shadow-xs space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-title font-bold text-base text-[#2C4219]">Data Produksi: Pengolahan Tepung Sorgum</h3>
        </div>
