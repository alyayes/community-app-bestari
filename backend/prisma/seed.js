  ...
  await p.agenda.createMany({
    data: [
      ...
      },
      {
        ...
        requirements: JSON.stringify(['Membawa cangkul kecil / sekop tangan', 'Memakai sarung tangan kebun']),
        benefits: JSON.stringify(['Bibit sorgum varietas Bioguma 1 (1 kantong)', 'Modul SOP budidaya ramah lingkungan']),
      ...
      },
      {
        ...
        requirements: JSON.stringify(['Membawa contoh produk olahan yang ingin dipasarkan', 'Membawa smartphone ber-kamera']),
        benefits: JSON.stringify(['Template stiker kemasan & panduan marketplace', 'Akses ke jaringan reseller komunitas Bestari']),
      ...
      },
      {
        ...
        requirements: JSON.stringify(['Membawa buku catatan & pasfoto 3x4']),
        benefits: JSON.stringify(['Sertifikat kelulusan pelatihan hygiene', 'Buku panduan sanitasi dapur produksi']),
      ...
      },
      {
        ...
        requirements: JSON.stringify(['Membawa caping, sarung tangan kebun, dan alat tulis']),
        benefits: JSON.stringify(['Bimbingan identifikasi OPT langsung di lapangan']),
